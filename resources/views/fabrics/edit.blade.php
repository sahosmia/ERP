        ...
        <form action="{{ route('admin.fabrics.update', $fabric) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="composition" name="composition" type="text" value="{{ $fabric->composition }}" required>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="qty" name="qty" type="number" step="0.01" value="{{ $fabric->qty }}" required>
                </div>
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="cuttable_width" name="cuttable_width" type="text" value="{{ $fabric->cuttable_width }}"
                        required>
                </div>
                <div class="mb-4">
                    ...
                    <select
                        ...
                        <option value="Sample Yardage" @if ($fabric->production_type == 'Sample Yardage') selected
                            @endif>Sample Yardage
                        </option>
